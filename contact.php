      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <h4><a href="https://github.com/rettus-code">Github Profile</a></h3>
            ...
            <p>Michael S Rettus II  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ph#(360) 499-9260</p>
            <p>Email: michael.rettusii@gmail.com</p>
        </div>
        <div class="col-lg-2 col-md-1"></div>
        <div class="container col-lg-4 col-md-6">
          <img src="images/me.jpg" class="pic" alt="Picture of me">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <form>
            ...
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Details and return contact information</label>
